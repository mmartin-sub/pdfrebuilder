...
class ImportAnalyzer:
    ...
    def analyze_project(self) -> dict:
        ...
        directories_to_scan = ["src", "tests", "scripts", "examples", "docs"]
    ...
    def generate_migration_plan(self, analysis_results: dict) -> dict:
        ...
        for file_path in current_src_files:
            if Path(file_path).exists():
                ...
                plan["files_to_move"].append({"from": file_path, "to": new_path})
        ...
        for dir_path in src_directories:
            if Path(dir_path).exists():
                ...
                plan["files_to_move"].append({"from": dir_path, "to": new_path, "type": "directory"})

        # Define import transformations
        plan["import_transformations"] = {
            "src.": "pdfrebuilder.",
            "from pdfrebuilder.": "from pdfrebuilder.",
            "import pdfrebuilder.": "import pdfrebuilder.",
        }
