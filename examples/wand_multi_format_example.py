...
def main():
            ...
            with patch(
                ...
                if can_parse:
                    try:
                        ...
                        print(f"    - Document structure units: {len(document.document_structure)}")
                        ...
                        for i, unit in enumerate(document.document_structure):
                            if isinstance(unit, CanvasUnit):
                                ...
                                for j, layer in enumerate(unit.layers):
                                    print(f"        - Layer {j + 1}: {layer.layer_name}")
    ...
    print("  The system can detect and extract multi-page TIFF files as separate canvas units.")
    print("  Each page becomes a separate document unit in the Universal IDM structure.")
