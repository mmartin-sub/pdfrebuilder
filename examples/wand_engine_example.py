...
from pdfrebuilder.engine.document_parser import WandParser, get_parser_by_engine
...
def main():
    ...
    if tesseract_available:
        ...
        print(f"✗ Tesseract is not available: {tesseract_info.get('error', 'unknown error')}")
    ...
    try:
        ...
        with patch("src.engine.document_parser.detect_file_format", return_value="png"):
            ...
            try:
                ...
                print(f"  - Successfully selected Wand engine: {type(selected_parser).__name__}")
    ...
    print("  - Set 'use_ocr: true' to extract text from rasterized text layers (requires Tesseract)")
