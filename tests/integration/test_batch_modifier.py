...
from pdfrebuilder.engine.batch_modifier import BatchModificationResult, BatchModifier, VariableSubstitution
...
class TestBatchModifierCLI:
    ...
    def test_cli_replace_command(self):
        ...
        from pdfrebuilder.cli.batch_modifier_cli import main
